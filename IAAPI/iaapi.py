...
def predict_treatment_status(phq_score, gad_score, gender):
    ...
    if result[0] == 1:
        return ("Vaya, parece que estos dias has estado de capa caida ¡No te preocupes!\n"
                "Recuerda que hay muchas herramientas clicando en la libreta que te pueden ayudar\n"
                "Sin embargo, si ves que esta situacion se alarga, siempre puedes buscar ayuda\n")
    else:
        return ("¡Wow! Estos dias has estado genial Enhorabuena, sigue asi \n"
                "Igualmente, recuerda que si lo necesitas siempre tendras recursos clicando en la libreta.")
